...
public:
	...
	bool add_object  (const char *type, const char      *name );
	...
	bool set_propbool(const char *name, const bool       value);
	bool set_property(const char *name, const tupple_t  *value);
	bool set_property(const char *name, const tripple_t *value);
};
