...
public:
	...
	virtual bool is_location(void) const { return true; }
	virtual bool save(FILE *fl);

	virtual bool move(Character *ch, const int dir);
	virtual void describe(Character *to, const descr_t typ = DESC_SHORT);

	virtual bool on_enter(Character *)
		{ return true; }
	virtual bool on_leave(Character *)
		{ return true; }
	...
	virtual bool add_child(Object *child, Object * = NULL)
		{
...
public:
	...
	virtual bool is_lock(void) const { return true; }
	bool is_locked(void) const { return m_locked; }

	/* event functions, to allow lock customization
	 * if they return true, the event is allowed to happen
	 */
	virtual bool on_lock  (Character *)
		{ return true; }
	virtual bool on_unlock(Character *)
		{ return true; }
	virtual bool on_pick  (Character *)
		{ return true; }

	virtual bool is_name(char *names)
...
public:
	...
	virtual bool is_door(void) const
		{ return true; }
	 ...
	 * if they return true, the event is allowed to happen
	 */
	virtual bool on_open (Character *)
		{ return true; }
	virtual bool on_close(Character *)
		{ return true; }
	virtual bool on_pass (Character *)
		{ return true; }
...
protected:
	virtual void on_resolve(Object *o, Property *)
		{
			if (o && o->is_lock())
			{
				o->m_parent  = this;
