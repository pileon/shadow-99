...
static bool find_door(int argc, char **argv, Character *ch, Door **door)
{
...
static bool find_lock(int argc, char **argv, Character *ch, Lock **lock)
{
	Door     *d   = NULL;
	Lock     *l   = NULL;
	Location *loc = (Location *) ch->m_parent;
...
static bool set_door(Character *ch, Door *door, const bool opn)
{
	const char *openclose = opn ? "open" : "closed";
...
static bool set_lock(Character *ch, Lock *l, const bool lock)
{
	const char *locks = lock ? "locked" : "unlocked";
