...
bool Loader::add_object(const char *type, const char *name)
{
...
bool Loader::set_property(const char *name, const char *value)
{
	Property *p;
...
bool Loader::set_property(const char *name, const int value)
{
	Property *p;
...
bool Loader::set_propref(const char *name, const char *value)
{
	Property *p;
...
bool Loader::set_propbool(const char *name, const bool value)
{
	Property *p;
...
bool Loader::set_property(const char *name, const tupple_t *value)
{
	Property *p;
...
bool Loader::set_property(const char *name, const tripple_t *value)
{
	Property *p;
