...
bool Object::prop_is_string(const char *name)
{
	Property *p = find_property(name);
	return (p && p->m_type == Property::PT_STRING);
}

bool Object::prop_is_number(const char *name)
{
	Property *p = find_property(name);
	return (p && p->m_type == Property::PT_NUMBER);
}

bool Object::prop_is_ref(const char *name)
{
	Property *p = find_property(name);
	return (p && p->m_type == Property::PT_REF);
}

bool Object::prop_is_bool(const char *name)
{
	Property *p = find_property(name);
	return (p && p->m_type == Property::PT_BOOL);
}

bool Object::prop_is_flag(const char *name)
{
	Property *p = find_property(name);
	return (p && p->m_type == Property::PT_FLAG);
}

bool Object::prop_is_bflag(const char *name)
{
	Property *p = find_property(name);
	return (p && p->m_type == Property::PT_BFLAG);
}

bool Object::set_property(Property *p, const char *v)
{
	if (!p || !v)
		return false;
...
bool Object::set_property(Property *p, const int v)
{
	if (!p)
		return false;
...
bool Object::set_propref(Property *p, const char *v)
{
	if (!p || !v)
		return false;
...
bool Object::set_property(Property *p, const tupple_t *v)
{
	if (!p || !v)
		return false;
...
bool Object::set_property(Property *p, const tripple_t *v)
{
	if (!p || !v)
		return false;
...
bool Object::rem_child(Object *child)
{
	Object *o = NULL;
...
bool Object::add_child(Object *child, Object * /* = NULL */)
{
...
void Object::describe(Character *to, const descr_t /* = DESC_SHORT */)
{
	to->write("a thing\r\n");
}
