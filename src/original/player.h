...
public:
	...
	virtual const bool is_player(void) const { return true; }
...
public:
	...
	virtual ~Wizard();
	virtual void init(void);
	virtual const bool is_wizard(void) const { return true; }
};
...
public:
	...
	virtual ~Archwiz();
	virtual void init(void);
	virtual const bool is_archwiz(void) const { return true; }
};
