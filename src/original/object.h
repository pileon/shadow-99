...
public:
	...
	virtual const bool is_object  (void) const { return true ; }
	virtual const bool is_char    (void) const { return false; }
	virtual const bool is_player  (void) const { return false; }
	virtual const bool is_wizard  (void) const { return false; }
	virtual const bool is_archwiz (void) const { return false; }
	virtual const bool is_monster (void) const { return false; }
	virtual const bool is_area    (void) const { return false; }
	virtual const bool is_zone    (void) const { return false; }
	virtual const bool is_location(void) const { return false; }
	virtual const bool is_lock    (void) const { return false; }
	virtual const bool is_door    (void) const { return false; }
	virtual const bool is_item    (void) const { return false; }
	virtual const bool is_key     (void) const { return false; }
	virtual const bool is_guild   (void) const { return false; }
	 ...
	 */
	virtual bool before(Character *ch, int argc, char **argv,
						const int cmd, const int scmd) { return true; }
	virtual bool after(Character *ch, int argc, char **argv,
					   const int cmd, const int scmd) { return true; }

	virtual const bool is_name(const char *names) { return false; }

	virtual void on_tick (void) {}
	virtual void on_fight(void) {}

	const bool is_clone(void) const { return m_clone; }
...
public:
	...
	const bool set_property (Property *prop, const char      *value);
	const bool set_property (Property *prop, const int        value);
	const bool set_propref  (Property *prop, const char      *value);
	const bool set_property (Property *prop, const tupple_t  *value);
	const bool set_property (Property *prop, const tripple_t *value);

	const bool prop_is_string(const char *name);
	const bool prop_is_number(const char *name);
	const bool prop_is_ref   (const char *name);
	const bool prop_is_bool  (const char *name);
	const bool prop_is_flag  (const char *name);
	const bool prop_is_bflag (const char *name);

	Property *find_property(const char *name) const;

	const bool resolve(void);
...
protected:
	...
	virtual void on_clone(Object *clone) const { *clone = *this; }
