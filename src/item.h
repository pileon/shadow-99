...
bool isname(char *str, const char *namelist);
...
public:
	...
	virtual bool is_item   (void) const { return true; }
	virtual bool is_equiped(void) const { return m_equiped; }
...
public:
	...
	virtual bool is_key(void) const { return true; }
};
